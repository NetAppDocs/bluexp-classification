...
. Select the name of a policy to display the results in the Investigation page. 
...
. Select *Governance*.
. Select the *Full Data Mapping Overview Report* button.
+
...
. To see details about a category, select it. The Investigation page provides data that is filtered for just that category. 
...
.Steps
. To see details about a file type, select it. The Investigation page provides data that is filtered for just that file type. 
