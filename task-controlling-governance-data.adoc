...
The Data Discovery Assessment Report provides high-level analysis of the scanned environment to highlight the system's findings and prove its value to the customer. highlights data-related concerns and proposes recommended remediation steps.

The goal of the DDA management briefing report is to raise awareness of four significant aspects that exist in the subject data set:

[cols="25,65",width=90%,options="header"]
|===
| Feature
| Description
| Data management challenges | Issues surrounding the granular day-to-day actions, short-term tactical engagements, and strategic projects.
| Data governance concerns | a detailed picture of all the data they own, starting with the information about the data (such as metadata and permissions), and proceeding with the contents and the context of the data.
| Data security exposures | .
| Data compliance gaps | distinguish between personal information and sensitive personal information.
|===

After the assessment, this report identifies areas where you can:

* Reduce storage costs by moving, tiering, or deleting data
* Protect your data that has broad permissions
* Protect your data that has personal or sensitive personal information
