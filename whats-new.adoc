...
=== Now you can add personal patterns that Data Sense will identify from the UI
...
https://docs.netapp.com/us-en/cloud-manager-data-sense/task-managing-data-fusion.html#add-custom-add-custom-keywords-from-a-list-of-words[Learn more about adding custom patterns from the Data Sense UI^].
