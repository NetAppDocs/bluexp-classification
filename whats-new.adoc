...
=== File access audit logging is now supported for data in your volumes

You can configure file access audit logging for critical volumes in your working environments. You can configure Data Sense to capture the following actions and the users who performed the action: Create, Read, Write, Delete, Rename, Change owner/permissions, and Change SACL/DACL. https://docs.netapp.com/us-en/cloud-manager-data-sense/task-manage-file-access-events.html[See how to monitor and manage file access events].
