...
=== Change from CentOS to Ubuntu (Version 1.34)

In Microsoft Azure and Google Cloud Platform (GCP), BlueXP classification has updated its Linux operating system from CentOS 7.9 to Ubuntu 22.04.
