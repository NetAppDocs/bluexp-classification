...
You can now view the scanning status of each work environment on the Configuration page:
...
=== Support added for RHEL v8.8 and 9.3 on the BlueXP Connector 
...
The following operating systems require using the Podman container engine, and they require BlueXP classification version 1.26 or greater: Red Hat Enterprise Linux version 8.8, 9.0, 9.1, 9.2, and 9.3.
...
=== Updates about communication with the service
We've updated information about communication with the service in the FAQ. 

Read more in the link:faq-cloud-compliance.html[FAQ].

//Read more in the https://docs.netapp.com/us-en/bluexp-classification/faq-cloud-compliance.html[FAQ].
