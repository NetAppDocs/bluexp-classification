...
// tag::whats-new[]
== 8 December 2022 (version 1.18)

=== On-premises installation program enhancements

Some additional prerequisites are now checked before the installation on an on-premises host. This helps to make sure your host system is 100% ready to have Data Sense software installed. Additionally, the Working Environments page now displays the _Working Environment ID_ and the _Scanner Group_ name. This information is needed if you plan to use multiple Data Sense hosts to provide additional processing power to scan your data sources.
