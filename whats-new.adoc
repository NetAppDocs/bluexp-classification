...
=== Configure Group IDs as "Open to Organization"

Now you can configure additional Group IDs in NFS to be considered as "Open to Organization" directly in BlueXP classification. This is useful when ......  See https://d[link:xxx] for details.
