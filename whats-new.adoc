...
//
//In earlier versions of Cloud Data Sense you could have email alerts sent to the BlueXP users in your account when certain critical Policies return results. This allows you to get notifications to protect your data. Now you can also choose to send email alerts to any other email address - up to 10 email addresses - not in your BlueXP account. 
//
