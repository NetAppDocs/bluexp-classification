...
=== Podman support on RHEL v8.x and 9.x for the BlueXP Connector 

This release provides support for Podman on RHEL v8.x in addition to previously supported 9.x. This applies also to dark sites, also known as _private mode._ 
