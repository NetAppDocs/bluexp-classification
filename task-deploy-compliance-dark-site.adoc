...
For versions 1.30 and earlier, if you need to install BlueXP classification on multiple hosts, refer to link:task-deploy-multi-host-install-dark-site.html[Install BlueXP classification on multipile hosts with no internet access].
