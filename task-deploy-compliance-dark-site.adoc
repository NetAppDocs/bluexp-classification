...
* Data Sense software can be upgraded one major version at a time. For example, if you have version 1.17.x installed, you can upgrade only to 1.18.x. If you are a few major versions behind, you'll need to upgrade the software multiple times.
