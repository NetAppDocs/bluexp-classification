...
Prioritization is limited to link:concept-cloud-compliance.md#whats-the-difference-between-mapping-and-classification-scans[mapping-only scans]; it's not available for map and classify scans. 
