...
[role="quick-margin-para"]
A BlueXP subscription through your cloud provider Marketplace is required. 
...
On-prem ONTAP systems, NetApp file shares, generic S3 Object storage, and databases can be scanned when using any of these cloud Connectors.
