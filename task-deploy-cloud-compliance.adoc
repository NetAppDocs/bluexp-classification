...
[role="quick-margin-para"]
The first 1 TB of data that Cloud Data Sense scans in BlueXP is free. A BlueXP subscription through your cloud provider Marketplace, or a BYOL license from NetApp, is required to continue scanning data after that point.
