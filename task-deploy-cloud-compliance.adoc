...
+
You can also click *Deploy > Configuration* to choose from two smaller instance types if you don't have a lot of data that you initially plan to scan. This can save some cloud cost when using a smaller instance. Then click *Deploy* to start the cloud deployment wizard.
+
