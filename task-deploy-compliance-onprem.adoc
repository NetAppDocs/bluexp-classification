...
https://youtu.be/gE-vrBLSJqw[Watch this video] to see how to install BlueXP classification.
...
+
Note that the installer performs a pre-check to make sure your system and networking requirements are in place for a successful installation. https://youtu.be/UZtn_I0e1Ls[Watch this video] to understand the pre-check messages and implications.
