...
//
//Review the following prerequisites to make sure that you have a supported configuration before you deploy BlueXP classification on a Linux system. 
...
Follow these steps when installing BlueXP classification software on a single on-premises host.
