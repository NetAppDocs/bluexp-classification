...
Users who have been using versions 1.30 or earlier will continue to be able to use that version until their subscription expires.
...
* Non-NetApp file shares (for example, Dell EMC Isilon, Pure Storage, Nutanix, and so on)
* Databases:
