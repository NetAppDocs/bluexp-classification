...
- **Mapping-only** scans provide only a high-level overview of your data and are performed on selected data sources. Mapping-only scans take less time than map and classify scans because the do not access files to see the data inside. 
- **Map and Classify** scans provide deep-level scanning of your data. 

Mapping-only scans enable you to quickly scan your data and identify data sources that might require more research, which you can then perform a Map & Classify scan on. 
