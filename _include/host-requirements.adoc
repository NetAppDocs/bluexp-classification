...
** The following operating systems require using the Podman container engine:

*** Red Hat Enterprise Linux version 9.2 (requires BlueXP classification version 1.25 or greater)
*** CentOS version 9.2 (requires BlueXP classification version 1.25 or greater)
+
Note that the following features are not currently supported when using RHEL/CentOS 9.x:
+
