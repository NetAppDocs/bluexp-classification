...
** Rocky Linux 9 (requires BlueXP classification version 1.24 and greater)
** Ubuntu 22.04 (requires BlueXP classification version 1.23 and greater)
...
+
https://youtu.be/H1WS_-85pWA[Watch this video] for a quick demo of installing Docker on CentOS.
