...
link:reference-collected-metadata.html#last-access-time-timestamp[See details about the "last accessed time timestamp"] for more information about the items that appear in the Scan Analysis Event.
