...
You can save the report in two different formats:

* As a .CSV file to the local machine; which can include up to 10,000 rows of data.
* As a .JSON file that you export to an NFS Share; which can include up to 100,000 rows of data. If there are more than 100,000 rows of data, additional .JSON files are created. 
+
