...
https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/use/task-creating-fsx-working-environment.html[See how to discover or create the FSx for ONTAP file system in BlueXP^].
...
+
NOTE: For FSx for ONTAP, Cloud Data Sense can scan volumes only in the same region as BlueXP.
