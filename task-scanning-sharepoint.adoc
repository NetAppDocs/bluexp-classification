...
Data Sense can scan both SharePoint Online accounts and SharePoint On-Premises accounts (SharePoint Server).
...
* For SharePoint On-Premises, you'll also need the Domain Name and IP address of the SharePoint server.
...
* For SharePoint On-Premises, Data Sense can be installed link:task-deploy-compliance-onprem.html[in an on-premises location that has internet access^] or link:task-deploy-compliance-dark-site.html[in an on-premises location that does not have internet access^]. When installed in a site without internet access, the Cloud Manager Connector also must be installed in that same site without internet access. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html[Learn more^].
...
+
image:screenshot_compliance_add_sharepoint_button.png[A screenshot of the Scan Configuration page where you can click the Add SharePoint Online button.]
...
+
image:screenshot_compliance_add_sharepoint_onprem_button.png[A screenshot of the Scan Configuration page where you can click the Add SharePoint On-premise button.]

. In the Insert Admin Credentials dialog, enter the following information:
