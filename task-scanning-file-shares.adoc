...
+
Data Sense can't extract permissions or last access time from 7-Mode systems. Additionally, there is a known issue where mounting CIFS shares on SMB version 2 is not supported for Linux.
