...
* If you're adding CIFS shares with Kerberos authentication, you must have first configured something.
...
. In the Add Files Shares Group dialog, enter the name for the group of shares then select *Continue* to complete creating the file share group. 
