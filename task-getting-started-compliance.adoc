...
BlueXP classification starts scanning the volumes you selected in the working environment. Results are available in the Compliance dashboard as soon as BlueXP classification finishes the initial scans. The time that it takes depends on the amount of data--it could be a few minutes or hours.  
