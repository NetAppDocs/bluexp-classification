...
* For on-premises ONTAP systems, https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html[BlueXP must discover the ONTAP clusters^]
...
Your Cloud Volumes ONTAP systems should already be available in the Canvas in BlueXP. For on-premises ONTAP systems, you'll need to have https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-discovering-ontap.html[BlueXP discover these clusters^].
