...
. You can add a new custom classifier from the _Custom Classifiers_ tab. You can also add one from the _Compliance_ tab if this is the first classifier you are adding.
+
image:screenshot_compliance_add_classifier_button.png[]
