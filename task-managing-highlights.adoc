...
Optionally, you can leave a breadcrumb file in the location of the moved file. A breadcrumb file helps your users understand why a file was moved from its original location. For each moved file, the system creates a breadcrumb file in the source location named '<filename>-breadcrumb-<date>.txt'. You can add text in the dialog box to indicate the location where the file was moved and the user who moved the file.
