...
* You must have permissions to copy files. link:concept-cloud-compliance.html[Learn about user access to compliance information].
...
* You must have permissions to copy and sync files. link:concept-cloud-compliance.html[Learn about user access to compliance information].
* You must select a minimum of 20 files.
...
* You must have permissions to move files. link:concept-cloud-compliance.html[Learn about user access to compliance information].
...
* You must have permissions to delete files. link:concept-cloud-compliance.html[Learn about user access to compliance information].
