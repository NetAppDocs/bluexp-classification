...
You can prioritize the most important scans--Mapping-only or Map and Classification. The ability to prioritize scans enables you to ensure ensure high priority scans are completed first.
