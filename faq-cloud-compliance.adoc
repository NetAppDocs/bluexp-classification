...
Yes. The information offered by BlueXP classification can be relevant to other stakeholders in your organizations, so we enable you to generate reports to share the insights. 

link:task-generating-compliance-reports.html[Learn about reports].
