...
====
*NOTE*    This information is relevant only for BlueXP classification versions 1.30 and earlier. The December 2023 (v1.26.6) release removed the option to integrate data using Azure Information Protection (AIP) labels. 
====
