...
.. Optionally, check the box if you want notification emails sent to other users, enter up to 10 email addresses, and choose the interval at which the email is sent.
...
Cloud Data Sense can send email alerts to BlueXP users in your account when certain critical Policies return results so you can get notifications to protect your data. You can choose to send the email notifications on a daily, weekly, or monthly basis. You can also choose to send email alerts to any other email address - up to 10 email addresses - not in your BlueXP account. 
